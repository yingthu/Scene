 ...
 * 
 * (* If machine is a Mac or otherwise doesn't support VAOs, the class
 *    keeps track of buffers itself and pretends state was maintained
 *    by setting up and tearing all of it down at each draw(). Also,
 *    while the bound element array (index array) is part of the
